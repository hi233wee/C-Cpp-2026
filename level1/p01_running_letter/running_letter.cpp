...
int main()
{
    ...
    c=input();
    if(c==0) c='7';
    printf("Don't change anything about the console window.\nWhen it is running, you can press the 'ESC' key to exit the program.");
    Sleep(waittime);
    system("cls");
    ...
    for(int i=1;i<n;i++)
    {
        ...
        if(Head.x==W) Head.o=2;
        else if(Head.y==H) Head.o=3;
        else if(Head.x==0) Head.o=4;
        else if(Head.y==0) Head.o=1;
